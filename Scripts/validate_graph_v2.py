...
def _calculate_score(d: dict) -> int:
    ...
    # Wortanzahl: +2 wenn 250-400, -1 wenn 200-250, -2 wenn <200
    wc = d['word_count']
    if 300 <= wc <= 400:
        score += 2
    elif 250 <= wc < 300:
...
if __name__ == "__main__":
    ...
    graph_path = project_root / "Band1" / "CYOA" / "v2" / "graph_v2.yaml"
    ...
    if export_report and qa_data:
        output_dir = project_root / "Band1" / "CYOA"
