...
# Open original
path = r"C:\Users\krugb\OneDrive\Desktop\GMBH\Projekte\Buecher\Die_Schattenjaeger\Band1\Cover\Bilder\DIE Geisterspuerer.pdf"
doc = fitz.open(path)
page = doc[0]
...
output_path = os.path.join(r"C:\Users\krugb\OneDrive\Desktop\GMBH\Projekte\Buecher\Die_Schattenjaeger\Output\Band1\PDF", "DIE Geisterspuerer_KDP.pdf")
