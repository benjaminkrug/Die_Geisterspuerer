...
| File | Purpose |
|------|---------|
| `Die_Geisterspuerer_Buchkonzept.md` | Series concept, market positioning, pricing, Amazon categories, cover direction |
| `Die_Geisterspuerer_Author_Info.md` | Writing instructions, character profiles, continuity tracker, setting details |
| `Die_Geisterspuerer_Band1_Story_Outline.md` | Band 1 chapter-by-chapter breakdown, 4-act structure, series arc (Bands 1-5) |
| `Schreibstil_Regeln_10_Jahre_Die_Geisterspuerer.md` | Detailed writing style rules for the target age group |
...
- **Horror-Humor balance:** After every scary moment, humor within 1-2 paragraphs (usually from Theo).
...
- **Chapter length:** 1,400-1,600 words, 18 chapters for Band 1.
